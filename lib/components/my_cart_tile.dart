          ...
          Padding(
            ...
            child: Row(
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  SizedBox(width: 70,child: Text(cartItem.food.name, style: TextStyle(fontWeight: FontWeight.bold),)),
                  Text("Rs. ${cartItem.food.price}", style: TextStyle(color: Theme.of(context).colorScheme.primary),),
                ],
              ),
